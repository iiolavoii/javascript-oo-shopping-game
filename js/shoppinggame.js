...
Object.defineProperty(Product, "dayToExpire",{
    get dayToExpire(){
        return this.dateDiff(Product.expiryDate, new Date());
    }

})
// Add method getDetails to Product here
Product.prototype.getDetails = function(name, price){
